import { NOOP_PROVIDER } from '../client/no-op-provider';
import { OpenFeatureCommonAPI } from '../shared/open-feature';
import { ApiEvents, EvaluationContext, FlagValue, ProviderMetadata } from '../shared/types';
...
export class OpenFeatureAPI extends OpenFeatureCommonAPI {
  ...
  addHooks(...hooks: Hook<FlagValue>[]): OpenFeatureCommonAPI {
  ...
  clearHooks(): OpenFeatureCommonAPI {
    this._hooks = [];
    return this;
  }
